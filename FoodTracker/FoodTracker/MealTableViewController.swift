...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals() {
        ...
        let meal1 = Meal(name: "burger", photo: photo1, rating: 3)!
        
        let photo2 = UIImage(named: "meal2")
        let meal2 = Meal(name: "soup", photo: photo2, rating: 5)!
    ...
    */
    ...
    // MARK: NSCoding
    func saveMeals() {
        let isSuccessfullySaved = NSKeyedArchiver.archiveRootObject(meals, toFile: Meal.ArchiveURL.path!)
